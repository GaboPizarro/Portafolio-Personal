...
export const personalInfo = {
  ...
  email: "sebastian.morales@uchile.cl",
  linkedin: "https://linkedin.com/in/sebastian-morales",
  github: "https://github.com/sebastianmorales",
  bio: "Estudiante de Ingeniería Civil Informática apasionado por el desarrollo de software, la inteligencia artificial y la innovación tecnológica. Busco crear soluciones que generen impacto real.",
...
export const educacionData: TimelineItem[] = [
  {
    ...
    description: "Formación en ciencias de la computación, ingeniería de software, sistemas distribuidos e inteligencia artificial. Participación activa en proyectos de investigación del FCFM.",
    tags: ["Algoritmos", "Sistemas Operativos", "IA", "BD", "Redes"],
    photos: [
      { src: "https://images.unsplash.com/photo-1562774053-701939374585?w=800&h=500&fit=crop", alt: "Campus universitario", caption: "Campus Beauchef, FCFM" },
  ...
  },
  {
    ...
    photos: [
      ...
      { src: "https://images.unsplash.com/photo-1427504494785-3a9ca7044f45?w=800&h=500&fit=crop", alt: "Sala de clases", caption: "Sala de clases Beauchef" },
...
export const proyectosData: ProjectItem[] = [
  {
    ...
    year: "2024",
    github: "https://github.com/sebastianmorales/chile-traffic-ai",
  ...
  },
  {
    ...
    year: "2023",
    github: "https://github.com/sebastianmorales/edu-cl",
    photos: [
  ...
  },
  {
    ...
    year: "2023",
    github: "https://github.com/sebastianmorales/blockvote",
    photos: [
  ...
  },
  {
    id: "proj-4",
    title: "Minga CLI",
    description: "Herramienta CLI para gestión de proyectos académicos FCFM",
    ...
    year: "2022",
    github: "https://github.com/sebastianmorales/minga-cli",
    photos: [
...
export const deportesData: SportItem[] = [
  {
    ...
    role: "Competidor — Club Escalar UChile",
    ...
    photos: [
      ...
      { src: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800&h=500&fit=crop", alt: "Boulder", caption: "Competencia boulder UChile" },
  ...
  },
  {
    id: "dep-2",
    sport: "Fútbol",
    role: "Mediocampista — Selección FCFM",
    period: "2019 — Presente",
    achievements: ["Campeón Interfacultades 2022", "Goleador del equipo 2021-2022", "Participación en Interfacultades UCh 2023"],
    description: "Seleccionado de fútbol de la Facultad de Ciencias Físicas y Matemáticas. Torneo interfacultades de la Universidad de Chile y torneos interuniversitarios en la Región Metropolitana.",
    photos: [
      ...
      { src: "https://images.unsplash.com/photo-1431324155629-1a6deb1dec8d?w=800&h=500&fit=crop", alt: "Entrenamiento", caption: "Entrenamiento en Beauchef" },
